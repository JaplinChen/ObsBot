...
```bash
npm run guardian:start    # 啟動守護器（http://127.0.0.1:3199）
npm run guardian:check    # 手動檢查一次
npm run guardian:status   # 查看當前狀態 JSON
npm run guardian:install-agent  # 安裝成背景服務
```
